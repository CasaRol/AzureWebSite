...
namespace Assignment2_alrol17.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CoursesID,CourseName,Semester,FinalGrade")] Courses courses)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CoursesID,CourseName,Semester,FinalGrade")] Courses courses)
        {
